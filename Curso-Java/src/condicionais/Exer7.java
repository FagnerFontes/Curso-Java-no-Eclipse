...
public class Exer7 {
	...
	public static void main(String[] args) {
		...
		double num3 = porta.nextDouble();
		
		System.out.println("=========================");
		if(num1 > num2 && num1> num3) {
			System.out.print("Este é o maior número: " + num1);
		}else if(num2 > num1 && num2 > num3 ) {
			System.out.println("Este é o maior número: " + num2); 
		}else if(num3 > num1 && num3 > num2) {
			System.out.println("Este é o maior número:  " + num3);
		}
		
		System.out.println("=========================");
		
		if(num1 < num2 && num1< num3) {
			System.out.print("Este é o menor número: " + num1);
		}else if(num2 < num1 && num2 < num3 ) {
			System.out.println("Este é o menor número: " + num2); 
		}else if(num3 < num1 && num3 < num2) {
			System.out.print("Este é o menor número:  " + num3);
		}		
	}	
}
